...
public class BrandsController : ControllerBase
{
    ...
    {
        var _brandsRepos = new AllRepositories<Brands>(this._context, this._context.Brands);
    ...
    public bool CreateBrand(string brandName)
    {
        ...
        else
        {
            ...
            return this._brandsIRepos.CreateItem(brand); // Create a new brand
        }
    }
    ...
    public bool DeleteBrandById(Guid id)
    {
        ...
        if (brandDel != null) return this._brandsIRepos.DeleteItem(brandDel);
        return false;
    }
    ...
    public bool UpdateBrand(Guid Id, string brandName)
    {
        ...
        return this._brandsIRepos.UpdateItem(brandUpdate); // cập nhật màu
    }
}