...
public class SIzes_ShoeDetailsController : ControllerBase
{
    ...
    {
        IAllRepositories<Sizes_ShoeDetails> iSizeShoeDetailsRepos =
            new AllRepositories<Sizes_ShoeDetails>(this._context, this._context.Sizes_ShoeDetails);
    ...
    public bool CreateSizeShoeDetails(Guid sizeId, Guid shoeDetailsId)
    {
        ...
        else
        {
            ...
            return this._iSizeShoeDetailsRepos.CreateItem(sizeShoeDetails); // tạo size mới
        }
    ...
    public bool DeleteSizeShoeDetails(Guid sizeId, Guid shoeDetailsId)
    {
        ...
        else
        {
            ...
            return this._iSizeShoeDetailsRepos.DeleteItem(sizeShoeDetails); // tạo size mới
        }
    ...
    public bool UpdateSizeShoeDetails(Guid id, Guid sizeId, Guid shoeDetailsId)
    {
        ...
        else
        {
            ...
            return this._iSizeShoeDetailsRepos.UpdateItem(sizeShoeDetails);
        }
