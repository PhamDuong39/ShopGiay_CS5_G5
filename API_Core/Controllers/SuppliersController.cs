...
public class SuppliersController : ControllerBase
{
    ...
    {
        var _suppliersRepos = new AllRepositories<Supplier>(this._context, this._context.Suppliers);
    ...
    public bool CreateSupplier(string addressSupplier)
    {
        ...
        else
        {
            ...
            return this._suppliersIRepos.CreateItem(supplier); // Create a new brand
        }
    }
    ...
    public bool DeleteSupplier(Guid id)
    {
        ...
        else
        {
            ...
            return this._suppliersIRepos.DeleteItem(supplier);
        }
    ...
    public bool UpdateSupplier(Guid id, string address)
    {
        ...
        return this._suppliersIRepos.UpdateItem(supplier);
    }
}