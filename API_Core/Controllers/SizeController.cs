...
public class SizeController : ControllerBase
{
    ...
    {
        var _sizeRepos = new AllRepositories<Sizes>(this._context, this._context.Sizes);
    ...
    public bool CreateSize(float sizeNumberCreate)
    {
        ...
        else
        {
            ...
            return this._sizeIrepos.CreateItem(size); // tạo size mới
        }
    }
    ...
    public bool DeleteSizeById(Guid id)
    {
        ...
        return this._sizeIrepos.DeleteItem(size);
    }
    ...
    public bool UpdateSizeById(Guid id, float sizeNumberUpdate)
    {
        ...
        return this._sizeIrepos.UpdateItem(size);
    }
}