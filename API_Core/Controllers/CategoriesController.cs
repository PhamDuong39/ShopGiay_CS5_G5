...
public class CategoriesController : ControllerBase
{
    ...
    {
        var _categoriesRepos = new AllRepositories<Categories>(this._context, this._context.Categories);
    ...
    public bool CreateCategory(string categoryName)
    {
        ...
        else
        {
            ...
            return this._categoriesIRepos.CreateItem(category); // Create a new brand
        }
    }
    ...
    public bool DeleteCategory(Guid id)
    {
        ...
        else
        {
            ...
            return this._categoriesIRepos.DeleteItem(category);
        }
        return false;
    }
    ...
    public bool UpdateCategory(Guid id, string categoryName)
    {
        var category = this._categoriesIRepos.GetAll().FirstOrDefault(p => p.Id == id);
        category.CategoryName = categoryName;
        return this._categoriesIRepos.UpdateItem(category);
    }
}