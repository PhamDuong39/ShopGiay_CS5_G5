...
public class ShoeDetailsController : ControllerBase
{
    ...
    {
        var _shoesDetails = new AllRepositories<ShoeDetails>(this._context, this._context.ShoeDetails);
        ...
        Guid idSale)
    {
        ...
        else
        {
            ...
            return this._iShoesDetails.CreateItem(shoeDetails); // tạo shoeDetails mới
        }
    }
    ...
    {
        return this._iShoesDetails.DeleteItem(this._iShoesDetails.GetAll().FirstOrDefault(p => p.Id == id));
    }
        ...
        Guid idSale)
    {
        ...
        else
        {
            ...
            shoeDetails.Status = status;
            shoeDetails.IdSale = idSale;
            return this._iShoesDetails.UpdateItem(shoeDetails);
        }
    }
}