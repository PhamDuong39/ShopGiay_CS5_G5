...
public class Color_ShoeDetailsController : ControllerBase
{
    ...
    {
        var _colorShoeDtails = new AllRepositories<Color_ShoeDetails>(this._context, this._context.Color_ShoeDetails);
    ...
    public bool CreateColor_ShoeDetails(Guid idShoeDetails, Guid idColor)
    {
        ...
        return this._iColor_ShoeDtails.CreateItem(color_shoeDetails); // tạo color_shoeDetails mới
    }
    // delete
    [HttpDelete("delete-color-shoeDetails")]
    public bool DeleteColor_ShoeDetails(Guid id)
    {
        return this._iColor_ShoeDtails.DeleteItem(this._iColor_ShoeDtails.GetAll().FirstOrDefault(p => p.Id == id));
    }
    ...
    public bool UpdateColorShoesDetails(Guid Id, Guid IdColor, Guid IdShoesDetails)
    {
        ...
        return this._iColor_ShoeDtails.UpdateItem(colorShoeDetails);
    }
}