...
public class DescriptionsController : ControllerBase
{
    ...
    {
        var _desRepos = new AllRepositories<Descriptions>(this._context, this._context.Descriptions);
    ...
    public async Task<bool> CreateDescriptionAsync(Guid idShoesDetails, string note1, string note2, string note3)
    {
        ...
        return this._iDesRepos.CreateItem(des); // tạo description mới
    }
    ...
    public bool DeleteDescription(Guid id)
    {
        ...
        if (this._iDesRepos.DeleteItem(des))
        {
    ...
    public bool UpdateDescription(Guid id, string note1, string note2, string note3)
    {
        ...
        des.Note2 = note2;
        des.Note3 = note3;
        return this._iDesRepos.UpdateItem(des);
    }
}