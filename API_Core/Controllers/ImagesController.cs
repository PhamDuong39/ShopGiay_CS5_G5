...
public class ImagesController : ControllerBase
{
    ...
    {
        var imagesRepos = new AllRepositories<Images>(this._context, this._context.Images);
    ...
    public bool CreateImage(string imageUrl, Guid idShoesDetails)
    {
        ...
        else
        {
            ...
            return this._imagesIRepos.CreateItem(image); // tạo image mới
        }
    }
    ...
    public bool DeleteImageById(Guid id)
    {
        ...
        return this._imagesIRepos.DeleteItem(imageDel);
    }
    ...
    public bool UpdateImage(Guid id, string imageUrl, Guid idshoesDetails)
    {
        ...
        return this._imagesIRepos.UpdateItem(image);
    }
}